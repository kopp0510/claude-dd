...
ZH = dict(
    ...
    l1=[("skills/", "10 個（每個含 SKILL.md）", "2 個 vendored，附上游授權", GREEN),
        ...
        ("templates/global/", "全域 CLAUDE.md 模板", "零幻覺 · 7 步迴圈 · skill 觸發", BLUE),
    ...
    l3=[("專案 CLAUDE.md", "7 步迴圈 + 專案專屬驗證指令", "巢狀，每個含程式碼的目錄一份", BLUE),
...
EN = dict(
    ...
    l1=[("skills/", "10, each with a SKILL.md", "2 vendored, license included", GREEN),
        ...
        ("templates/global/", "global CLAUDE.md template", "zero-hallucination · 7-step loop", BLUE),
    ...
    l3=[("project CLAUDE.md", "7-step loop + project-specific verify commands", "nested — one per directory containing code", BLUE),
